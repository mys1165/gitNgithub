...
<div class="container">
  ...
  <form role="form" action="board_update.do" method="post">
  	<div class="row">
      <label class="col-xs-1" for="num">글번호</label>
      <div class="col-xs-6">
        <input readonly readonly type="text" class="form-control" id="num" name="c_board_num" value="${dto.c_board_num}">
      </div>
    </div>
    <div class="row">
    ...
    <div class="row">
      ...
      <div class="col-xs-6">
        <input readonly type="text" class="form-control" id="author" name="c_board_author" value="${dto.c_board_author}">
      </div>
    </div>
    <div class="row">
