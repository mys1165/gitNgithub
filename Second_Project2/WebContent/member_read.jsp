...
<div class="container">
	...
	<div class="page-footer">
        ...
        <a href="member_updateui.do?c_member_id=${login.c_member_id}" class="btn btn-info btn-lg">
          <span class="glyphicon glyphicon-edit"></span> 회원정보수정
        </a>&nbsp;&nbsp;&nbsp;
        <a href="member_delete.do?c_member_id=${login.c_member_id}" class="btn btn-info btn-lg">
